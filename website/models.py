...
class User(db.Model, UserMixin):
    ...
    preferedWorkTime = db.Column(db.Integer, nullable=False) #it can be either 1 (night time) or 0 (day time)
...
class Assignment(db.Model):
    ...
    timeslots = db.relationship("Timeslot")#db.Integer, uselist=False, backref="timeslot")
